...
# Open an InsertCursor and insert the new geometry
        ...
        cursor = arcpy.da.InsertCursor(fc, ['SHAPE@', 'TYPE', 'SA', 'TTPK', 'TTC', 'TTA', 'TTPS', 'LOD_P', 'LOD_NON', 'MCPS', 'TCPS', 'WVPS', 'WWPS'])        
        cursor.insertRow([polygon, "Micro Vac", "144", "0.18", "0.15", "0.8", "1.21", "105", "0", "34.28", "395.84", "0", "4.3"])
        del cursor
...
class ToolClass17(object):
    ...
    def onLine(self, line_geometry):  
            ...
            polygon = arcpy.Polygon(array)
            cursor = arcpy.da.InsertCursor(fc, ['SHAPE@', 'TYPE', 'SA', 'TTPK', 'TTC', 'TTA', 'TTPS', 'LOD_P', 'LOD_NON', 'MCPS', 'TCPS', 'WVPS', 'WWPS']) #new
            cursor.insertRow([polygon, "Wet Vac", "28800", "0.33", "0.13", "0.5", "1.07", "105", "40", "167", "220", "5", "28.5"])
...
class ToolClass19(object):
    ...
    def onLine(self, line_geometry):  
            ...
            polygon = arcpy.Polygon(array)
            cursor = arcpy.da.InsertCursor(fc, ['SHAPE@', 'TYPE', 'SA', 'TTPK', 'TTC', 'TTA', 'TTPS', 'LOD_P', 'LOD_NON', 'MCPS', 'TCPS', 'WVPS', 'WWPS']) #new
            cursor.insertRow([polygon, "Robot", "144000", "0.17", "0.6", "0.5", "1.12", "105", "140", "207", "267", "0.5", "10.5"])
...
class ToolClass21(object):
    ...
    def onLine(self, line_geometry):  
            ...
            polygon = arcpy.Polygon(array)
            cursor = arcpy.da.InsertCursor(fc, ['SHAPE@', 'TYPE', 'SA', 'TTPK', 'TTC', 'TTA', 'TTPS', 'LOD_P', 'LOD_NON', 'MCPS', 'TCPS', 'WVPS', 'WWPS']) #new
            cursor.insertRow([polygon, "Agressive Air", "12000", "0.17", "0.6", "0.5", "1.12", "105", "140", "207", "267", "0.5", "10.5"])
...
# Open an InsertCursor and insert the new geometry
        ...
        cursor = arcpy.da.InsertCursor(fc, ['SHAPE@', 'TYPE', 'SA', 'TTPK', 'TTC', 'TTA', 'TTPS', 'LOD_P', 'LOD_NON', 'MCPS', 'TCPS', 'WVPS', 'WWPS'])        
        cursor.insertRow([polygon, "Swab", "4", "0.12", "0.07", "0.7", "0.89", "25", "0", "21", "219", "0", "0"])
        del cursor
        arcpy.RefreshActiveView()
...
# Create a polygon geometry
        ...
        cursor = arcpy.da.InsertCursor(fc, ['SHAPE@', 'TYPE', 'SA', 'TTPK', 'TTC', 'TTA', 'TTPS', 'LOD_P', 'LOD_NON', 'MCPS', 'TCPS', 'WVPS', 'WWPS'])        
        cursor.insertRow([polygon, "Sponge", "100", "0.12", "0.09", "0.7", "0.99", "14", "0", "46.87", "343.03", "0", "4.3"])
        del cursor
        arcpy.RefreshActiveView()
